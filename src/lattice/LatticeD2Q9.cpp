 ...
 */
template<class T>
void LatticeD2Q9<T>::WriteToCSV(const std::string& path, const char letter, const std::string& runId, const int timestep) const {
 ...
 */
 template<class T>
std::string LatticeD2Q9<T>::construct_basepath(const std::string& path, const std::string& runId, const int timestep, const char letter) const
{
